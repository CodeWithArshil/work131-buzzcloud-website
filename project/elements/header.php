                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="menu-wrap">
                            <nav class="menu-nav">
                                <div class="logo">
                                    <a href="index-2.html"><img src="assets/img/logo/Buzzcloud-Logo.png" alt="Logo"></a>
                                </div>
                                        ...
                                        <div class="contact-info-list">
                                            <ul class="list-wrap">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="content">
                                                        <span>21st floor, D Block, Westgate by true value, Sarkhej -
                                                            Gandhinagar Hwy, Makarba, Ahmedabad, Gujarat 380015</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="icon">
                                                    ...
                                                    <div class="content">
                                                        <span>7 Days a week <br> from 11-00 am to 8-00 pm</span>
                                                    </div>
                                                </li>
                                            </ul>
                                            <div class="lats-chat">
